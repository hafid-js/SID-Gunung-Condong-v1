...
<head>
    ...
    <!-- Select2 -->
    <link rel="stylesheet" href="{{ asset('admin-2/bower_components/select2/dist/css/select2.min.css') }}">
    <!-- DataTables CSS -->
    <link rel="stylesheet"
        href="{{ asset('admin-2/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css') }}">
    <!-- Bootstrap Color Picker -->
    <link rel="stylesheet"
        href="{{ asset('admin-2/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}">
    <!-- Theme style -->
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <!-- Select2 -->
        <script src="{{ asset('admin-2/bower_components/select2/dist/js/select2.full.min.js') }}"></script>
        <!-- Slimscroll -->
