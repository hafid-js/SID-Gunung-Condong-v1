                                                ...
                                                <div class="form-group row mb-0">
                                                    <div class="col-sm-12">
                                                        <div class="box-header with-border">
                                                            <strong><a href="{{ url('kategori') }}">MENU UTAMA</a> : BERITA DESA</strong>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <thead class="thead-gray disabled color-palette">
                                                ...
                                                <tbody>
                                                    <tr class="font-12">
                                                        ...
                                                        <td>1</td>
                                                        <td class="aksi">
                                                            <a href="#" data-href="#" class="btn bg-orange btn-sm" title="Ubah Data" data-toggle="modal" data-target="#modal2">
