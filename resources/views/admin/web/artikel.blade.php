...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0" style="font-weight: 400;">Artikel</h5>
                </div>
                <div class="col-sm-6">
                                            ...
                                            <table class="table table-hover table-bordered text-nowrap ">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>1</td>
                                                        <td class="aksi">
                                                            <a href="{{ url('form') }}" class="btn bg-orange btn-sm" title="Ubah Data">
                                                                <i class="fa fa-edit text-white"></i>
                                                            </a>
                                                            <a href="#" data-dismiss="modal" class="btn bg-danger btn-sm" data-toggle="modal" data-target="#modal1" title="Hapus">
                                                                <i class="fa fa-trash text-white"></i>
                                                            </a>
                                                            <a href="#" data-dismiss="modal" class="btn bg-purple btn-sm" data-toggle="modal" data-target="#modal2" title="Ubah Kategori">
                                                                <i class="fa fa-folder-open text-white"></i>
                                                            </a>
                                                            <a href="#" id="berhasil" class="btn bg-info btn-sm" title="Tutup Komentar Artikel">
                                                                <i class="fa fa-comment-o text-white"></i>
                                                            </a>
                                                            <a href="#" class="btn bg-navy btn-sm" title="Non Aktifkan Artikel">
                                                                <i class="fa fa-unlock text-white"></i>
                                                            </a>
                                                            <a href="#" class="btn bg-teal btn-sm" title="Jadikan Berita Utama">
                                                                <i class="fa fa-star-o text-white"></i>
                                                            </a>
                                                            <a href="#" class="btn bg-gray btn-sm" title="Masukkan ke dalam slide">
                                                        ...
                                                        <td>Rapat membangun Komitmen antara Karang Taruna Desa Senggigi dengan Taruna Hotel</td>
                                                        <td>2 Kali</td>
