        ...
        <section id="maincontent" class="content">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <a href="#0" data-remote="false" data-toggle="modal" data-target="#tambahMenu" data-title="Tambah "
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th nowrap="" class="sorting_disabled" rowspan="1" colspan="1"
                                                        aria-label="NAMA MENU">NAMA MENU</th>
                                                    <th nowrap="" class="sorting_disabled" rowspan="1" colspan="1"
                                                        aria-label="LINK">LINK</th>
                                                </tr>
                                            </thead>
                                            <tbody id="dragable" class="ui-sortable">
                                                <tr data-id="2" class="dragable-handle odd" role="row">
                                                    <td class=" padat"><i class="fa fa-sort-alpha-desc"></i></td>
                                                    <td class=" padat"><input type="checkbox" name="id_cb[]" value="2"></td>
                                                    <td class=" padat">1</td>
                                                    <td class=" aksi"><a href="{{ url('menu/sub') }}"
                                                            class="btn bg-purple btn-sm" title="Submenu"
                                                            style="margin-right: 3px;">
                                                            <i class="fa fa-bars"></i>
                                                        </a>
                                                        <a href="h#" class="btn bg-orange btn-sm" data-remote="false"
                                                            data-toggle="modal" data-target="#ubahMenu"
                                                            data-title="Ubah Menu" title="Ubah"><i
                                                    ...
                                                    <td>TES &amp; menu</td>
                                                    <td><a href="#"
                                                            target="_blank">https://berputar.opendesa.id/data-wilayah</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
            ...
            <div class="modal fade in" id="tambahMenu" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
                >
                            ...
                            <form action="#" method="post" id="validasi">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="nama" class="form-control input-sm required nomor_sk" maxlength="50"
                                            type="text" value="">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" id="jenis_link" style="display: none;">
                                        ...
                                        <select id="artikel_statis"
                                            class="form-control input-sm jenis_link select2 select2-hidden-accessible"
                                            style=" display:none; " data-select2-id="artikel_statis" tabindex="-1"
                                            aria-hidden="true">
                                            <option value="" data-select2-id="165">-- Pilih Artikel Statis --</option>
                                            ...
                                            dir="ltr" data-select2-id="164" style="width: 100%; display: none;"><span
                                                class="selection"><span class="select2-selection select2-selection--single"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                    aria-labelledby="select2-artikel_statis-container"><span
                                                        class="select2-selection__rendered"
                                                        id="select2-artikel_statis-container" role="textbox"
                                                        aria-readonly="true" title="-- Pilih Artikel Statis --">-- Pilih
                                                        Artikel Statis --</span><span class="select2-selection__arrow"
                                                        role="presentation"><b
                                        ...
                                        <select id="kategori_artikel" class="form-control input-sm jenis_link"
                                            ...
                                            <option value="kategori/peraturan-kebersihan-desa">Peraturan Kebersihan Desa
                                            </option>
                                        ...
                                        <select id="statistik_penduduk" class="form-control input-sm jenis_link"
                                            ...
                                            <option value="statistik/status-asuransi-kesehatan">Status Kepersertaan Asuransi
                                                Kesehatan</option>
                                        ...
                                        <select id="statistik_kesehatan" class="form-control input-sm jenis_link"
                                            style=" display:none; ">
                                        ...
                                        <select id="kelompok" class="form-control input-sm jenis_link"
                                            style=" display:none; ">
                                            <option value="">Pilih Kelompok</option>
                                            <option value="data-kelompok/1">dddd ()</option>
                                        </select>
                                        <select id="lembaga" class="form-control input-sm jenis_link"
                                            style=" display:none; ">
                                            <option value="">Pilih Lembaga</option>
                                        </select>
                                        <select id="suplemen" class="form-control input-sm jenis_link"
                                            style=" display:none; ">
                                            <option value="">Pilih Suplemen</option>
                                        </select>
                                        <select id="status_idm" class="form-control input-sm jenis_link"
                                            style=" display:none; ">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-social btn-info btn-sm confirm"><i
            ...
            <div class="modal fade in" id="ubahMenu" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
               >
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="parrent" class="form-control input-sm required">
                                            ...
                                            <option value="2">TES &amp;amp; menu</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="nama">Nama</label>
                                        <input name="nama" class="form-control input-sm required nomor_sk" maxlength="50"
                                            type="text" value="TES &amp;amp; menu">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control input-sm required" id="link_tipe" name="link_tipe"
                                            ...
                                            <option value="4">Statistik Program Bantuan</option>
                                            <option value="12">Statistik Kesehatan</option>
                                            <option value="5" selected="">Halaman Statis Lain</option>
                                            <option value="6">Artikel Keuangan</option>
                                            <option value="7">Kelompok</option>
                                            <option value="11">Lembaga</option>
                                            <option value="9">Data Suplemen</option>
                                    ...
                                    <div class="form-group" id="jenis_link" style="">
                                        <label class="control-label" for="link">Link</label>
                                        <select id="artikel_statis"
                                            class="form-control input-sm jenis_link select2 select2-hidden-accessible"
                                            style=" display:none; " data-select2-id="artikel_statis" tabindex="-1"
                                            aria-hidden="true">
                                            <option value="" data-select2-id="113">-- Pilih Artikel Statis --</option>
                                            <option value="artikel/7">Awal mula SID</option>
                                            <option value="artikel/32">Profil Desa</option>
                                            <option value="artikel/34">Profil Masyarakat Desa</option>
                                            <option value="artikel/36">Kontak Kami</option>
                                            ...
                                            dir="ltr" data-select2-id="112" style="width: 100%; display: none;"><span
                                                class="selection"><span class="select2-selection select2-selection--single"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                    aria-labelledby="select2-artikel_statis-container"><span
                                                        class="select2-selection__rendered"
                                        ...
                                        <select id="statis_lainnya"
                                            class="form-control input-sm jenis_link required select2-hidden-accessible"
                                            style="" name="link" data-select2-id="statis_lainnya" tabindex="-1"
                                            aria-hidden="true">
                                            <option value="">-- Pilih Halaman Statis Lainnya --</option>
                                            <option value="dpt">Calon Pemilih</option>
                                            <option value="data-wilayah" selected="" data-select2-id="131">Wilayah
                                            ...
                                            dir="ltr" data-select2-id="130" style="width: 100%;"><span
                                                class="selection"><span class="select2-selection select2-selection--single"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                    aria-labelledby="select2-statis_lainnya-container"><span
                                                        class="select2-selection__rendered"
                                                        id="select2-statis_lainnya-container" role="textbox"
                                                        aria-readonly="true" title="Wilayah Administratif">Wilayah
                                                        Administratif</span><span class="select2-selection__arrow"
                                                        role="presentation"><b
                                                            role="presentation"></b></span></span></span><span
                                                class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        <select id="artikel_keuangan" class="form-control input-sm jenis_link"
                                        ...
                                        <span id="eksternal" class="jenis_link" style=" display:none; ">
                                            <input name="" class="form-control input-sm" type="text" value="data-wilayah">
                                            <span class="text-sm text-red">(misalnya: https://opendesa.id)</span>
                                        </span>
                                    </div>
                                    <div class="form-group">
