                                    ...
                                    <div class="card-body p-0">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12 col-lg-4 col-md-5">
                                                <label for="nama" class="col-form-label font-12" for="apbDesFooter">Apakah
                                                    akan tampilkan grafik APBDes di halaman
                                                    muka</label>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12 col-lg-4 col-md-5">
                                                <label for="nama" class="col-form-label font-12" for="artikelStatis">Artikel
                                                    Statis / Halaman yang akan ditampilkan
