                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12">
                                        <div class="dt-buttons btn-group flex-wrap">
                                            <div class="margin">
                                                <a href="#" data-dismiss="modal" id="btn-add" class="btn btn-social mt-1 mb-1 btn-success btn-xs" data-toggle="modal" data-target="#modal1" title="Tambah Kategori">
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-sm-6 col-md-9 col-lg-9">
                                        <div id="example1_filter" class="dataTables_filter">
                                            <label>Cari:
                                                <input type="search" class="form-control form-control-sm" placeholder="Kata Kunci Pencarian" aria-controls="example1">
                                            </label>
                                        </div>
                                    </div>
                                </div>
