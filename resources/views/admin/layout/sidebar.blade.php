               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item {{ $open }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ url('artikel') }}" class="nav-link {{ $active }} {{ $callout }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ url('kategori') }}" class="nav-link {{ $active }} {{ $callout }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ url('widget') }}" class="nav-link {{ $active }} {{ $callout }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ url('menu') }}" class="nav-link {{ $active }} {{ $callout }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ url('komentar') }}" class="nav-link {{ $active }} {{ $callout }}">
                    ...
                    <ul class="nav nav-treeview">
                        @if (Session::get('page') == 'galeri' || Session::get('page') == 'form-galeri' || Session::get('page') == 'sub-galeri')
                                                @php
                                                    $active = "active";
                                                    $callout = "callout callout-icon-primary";
                                                 @endphp
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ url('galeri') }}" class="nav-link {{ $active }} {{ $callout }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ url('sosmed') }}" class="nav-link {{ $active }} {{ $callout }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ url('slider') }}" class="nav-link {{ $active }} {{ $callout }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ url('teks-berjalan') }}" class="nav-link {{ $active }} {{ $callout }}">
                    ...
                    <ul class="nav nav-treeview">
                        @if (Session::get('page') == 'pengunjung')
                                                @php
                                                    $active = "active";
                                                    $callout = "callout callout-icon-primary";
                                                 @endphp
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="pages/layout/top-nav.html" class="nav-link {{ $active }} {{ $callout }}">
                    ...
                    <ul class="nav nav-treeview">
                        @if (Session::get('page') == 'setting-web')
                                                @php
                                                    $active = "active";
                                                    $callout = "callout callout-icon-primary";
                                                 @endphp
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ url('setting-web') }}" class="nav-link {{ $active }} {{ $callout }}">
