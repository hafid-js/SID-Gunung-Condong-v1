    ...
    <div class="content-wrapper" style="min-height: 912.43px;">
        <section class="content-header">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li><a href="{{ url('dusun/rw') }}"> Wilayah Administratif RW</a></li>
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <a onclick="window.history.back()"
                        ...
                        <i class="fa fa-arrow-circle-left "></i>Kembali ke Wilayah Administratif RW
                    </a>
                </div>
                <form action="#" class="form-horizontal" id="validasi"
                    enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <input type="hidden" name="sidcsrf" value="e3c46483076816cb78d1a73b5f978a09">

                    <div class="box-body">
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="nama">Nama RW</label>
                            <div class="col-sm-7">
                                <input id="nama" class="form-control input-sm nama_terbatas required" maxlength="50"
                                    type="text" placeholder="Nama RW" name="rw" value="">
                            </div>
                        </div>
                        <div class="form-group">
